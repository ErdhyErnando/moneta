...
const categoryColors = [
	...
	{ bg: "bg-cyan-100", text: "text-cyan-700", darkBg: "dark:bg-cyan-900/30", darkText: "dark:text-cyan-300" },
	{ bg: "bg-yellow-100", text: "text-yellow-700", darkBg: "dark:bg-yellow-900/30", darkText: "dark:text-yellow-300" },
	{ bg: "bg-indigo-100", text: "text-indigo-700", darkBg: "dark:bg-indigo-900/30", darkText: "dark:text-indigo-300" },
	{ bg: "bg-rose-100", text: "text-rose-700", darkBg: "dark:bg-rose-900/30", darkText: "dark:text-rose-300" },
	{ bg: "bg-teal-100", text: "text-teal-700", darkBg: "dark:bg-teal-900/30", darkText: "dark:text-teal-300" },
	{ bg: "bg-amber-100", text: "text-amber-700", darkBg: "dark:bg-amber-900/30", darkText: "dark:text-amber-300" },
	{ bg: "bg-emerald-100", text: "text-emerald-700", darkBg: "dark:bg-emerald-900/30", darkText: "dark:text-emerald-300" },
	{ bg: "bg-violet-100", text: "text-violet-700", darkBg: "dark:bg-violet-900/30", darkText: "dark:text-violet-300" },
	{ bg: "bg-fuchsia-100", text: "text-fuchsia-700", darkBg: "dark:bg-fuchsia-900/30", darkText: "dark:text-fuchsia-300" },
	{ bg: "bg-lime-100", text: "text-lime-700", darkBg: "dark:bg-lime-900/30", darkText: "dark:text-lime-300" },
	{ bg: "bg-sky-100", text: "text-sky-700", darkBg: "dark:bg-sky-900/30", darkText: "dark:text-sky-300" },
];
